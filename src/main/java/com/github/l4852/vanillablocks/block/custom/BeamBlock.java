...
public class BeamBlock extends Block {
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        ...
        switch (direction) {
            case NORTH -> {
                return VoxelShapes.cuboid(0, 0, 0, 0.5, 1, 0.5);
            }
            case SOUTH -> {
                return VoxelShapes.cuboid(0.5, 0, 0.5, 1, 1, 1);
            }
            case EAST -> {
                return VoxelShapes.cuboid(0.5, 0, 0, 1, 1, 0.5);
            }
            case WEST -> {
                return VoxelShapes.cuboid(0, 0, 0.5, 0.5, 1, 1);
            }
            default -> {
